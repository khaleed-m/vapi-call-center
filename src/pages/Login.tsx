...
const Login: React.FC<LoginProps> = ({ onLogin, className }) => {
    ...
    <div className={cn("min-h-screen bg-background flex items-center justify-center p-6", className)}>
      ...
      <div className="absolute top-4 left-4 md:top-6 md:left-6 z-20">
        <img 
          src="/logo.png" 
          alt="Logo" 
          className="w-16 h-16 md:w-20 md:h-20 object-contain logo-crisp"
          style={{
      ...
      {/* Login Card */}
      <Card className="relative z-10 w-full max-w-md p-8 bg-card/80 backdrop-blur-sm border-border/50 shadow-card">
        <div className="space-y-6">
          {/* Header */}
          <div className="text-center space-y-2">
            <h1 className="text-3xl font-bold gradient-text">Welcome Back</h1>
            <p className="text-muted-foreground">Sign in to access your AI voice assistant</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
              ...
              className={cn(
                ...
                "py-3 rounded-xl transition-all duration-500",
                "voice-glow hover:scale-105 hover:shadow-glow",
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button variant="outline" className="bg-background/50 border-border/50 hover:bg-background/80">
